...
public class GuestPreferences implements Serializable {
    ...
    private String componentTheme = "green-light";
    
    private String menuMode = "layout-slim-plus";
    
    private String menuColor = "red";
    
    private String menuTheme = "red";
    ...
    public void init() {
        ...
        /* Menu: Light | Active: Orange | Topbar: Purple | Components: Orange Light */
        palettes.add(
            new Palette(
                new Color("light", "#f8fafc", null),
