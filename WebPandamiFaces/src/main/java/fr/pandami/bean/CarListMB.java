package fr.pandami.bean;

import fr.pandami.infra.model.Filter;
import fr.pandami.model.Car;
import fr.pandami.service.CarService;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? fr.pandami.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? fr.pandami.infra.model.SortOrder.DESCENDING
                            : fr.pandami.infra.model.SortOrder.UNSORTED;
                }
